...
if(!empty($sch_title)){
    $where_query .= " and tf_title like ? ";
    $data_array[] = "%$sch_title%";
}


$query ="select count(*) as cnt from tbl_faq 
         {$where_query}";
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <button type="button" class="btn page-link" onclick="location.href='/manage/view/faq/faq_view.php'">+ FAQ 등록</button>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                        ...
                                        <div class="col-sm-12">
                                            <table id="example1"
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="text-center"><?=$val['tf_status']=='Y'?'노출':'비노출';?></td>
                                                    <td class="text-center"><?=$val['tf_regdate']?></td>
                                                    <td class="text-center"><?=$val['tf_fix']=='Y'?'고정':'-';?></td>
                                                    <td><a href="faq_view.php?seq=<?=$val['tf_seq']?>&<?=$subquery?>"><?=$val['tf_title']?></a></td>
                                                    <td class="text-center">썸네일</td>
                                                    <td class="text-center">
                                                        <button type="button" class="btn btn-warning" onclick="location.href='faq_view.php?seq=<?=$val['tf_seq']?>&<?=$subquery?>'" >수정</button>
